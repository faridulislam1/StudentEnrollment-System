                ...
                <div class="card-body overview">
                  ...
                  <div class="info-links">
                    <a class="website">
                     ...
                     {{$student_descrition_profile ->student_fathersname}}</span>
                    </a>
                   <a class="website">
                      <i class="icon-globe icon">Mothers Name:</i>
                      <span style="font-family:vernada; font-size:15px;">{{$student_descrition_profile ->student_mothersname}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon">Address:</i>
                      <span style="font-family:vernada; font-size:15px;">{{$student_descrition_profile ->student_address}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon">Department:</i>
                      <span style="font-family:vernada; font-size:15px;">

                      	{{convert_department($student_descrition_profile ->student_department)}}</span>
                    </a>
                    <a class="website">
                      <i class="icon-globe icon">Admissionyear:</i>
                      <span style="font-family:vernada; font-size:15px;">{{$student_descrition_profile ->student_admissionyear}}</span>
                    </a>
                  </div>
                </div>
              </div>
