                  ...
                  <div class="card w-100">
                    <div class="card-body px-3" style="height:333px">
                      ...
                      <div class="list py-2 d-flex flex-row align-items-center">
                        ...
                        <div class="profile-name">Arif Islam</div>
                      ...
                      <div class="list py-2 d-flex flex-row align-items-center">
                        ...
                        <div class="profile-name">Rajib Sheikh</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Musa Ahmed</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Uzzal Sheikh</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Kawser Islam</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                    </div>
                  </div>
