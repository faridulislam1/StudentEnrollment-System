...
@section('content')
 ...
 <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                ...
                @endphp
                  <p style="font-family:;font-size:27px;text-align: center;font-weight:bold ;">{{$student}}</p>
                </div>
                  ...
                  <h2 class="card-title">All Teachers</h2>
                   @php 
                    $teacher=DB::table('teachers_tbl')
                       ->count('teachers_id');
                       @endphp
                  <p style="font-family:;font-size:27px;text-align: center;font-weight:bold ;">{{$teacher}}</p>
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                ...
                <p style="font-family:;font-size:27px;text-align: center;font-weight:bold ;">Monthly:2500 tk</p>
            ...
            <div class="col-sm-6 col-md-3 grid-margin">
              <div class="card">
                <div class="card-body">
                  <h2 class="card-title">Revenew</h2>
                <p style="font-family:;font-size:27px;text-align: center;font-weight:bold ;">10000</p>
                ...
                <div class="col-12 grid-margin d-flex align-items-stretch">
                  <div class="row">
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-facebook"><i class=""></i><p class="mb-0">
                      CSE</p>
                    </div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-twitter"><i class=""></i><p class="mb-0">EEE</p></div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-12 mb-3">
                      <div class="social-panel bg-google"><i class=""></i><p class="mb-0">BBA</p></div>
                    </div>
                    <div class="col-12 col-sm-6 col-md-12">
                      <div class="social-panel bg-linkedin"><i class=""></i><p class="mb-0">MBA</p></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card w-100">
                    <div class="card-body px-3" style="height:333px">
                      ...
                      <div class="list py-2 d-flex flex-row align-items-center">
                        ...
                        <div class="profile-name">Ratul Islam</div>
                      ...
                      <div class="list py-2 d-flex flex-row align-items-center">
                        ...
                        <div class="profile-name">Rakibul Sheikh</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Majnu Islam</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Abu Talha</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                      <div class="list py-2 d-flex flex-row align-items-center">
                        <div class="profile-img mr-4">
                        ...
                        <div class="profile-name">Rahman Sarker</div>
                        <div class="current-progress ml-auto">450/900</div>
                      </div>
                    </div>
                  </div>
